...
TEST(RandomUtils, get_random_bits_64) {
    // cannot provide 128 bit literals directly? lets have upper bits zeroed..
    RandomMocker::Mock<__uint128_t> mock_random{{ 0x0123456789abcdefULL, 0xfedcba9876543210ULL }};
    EXPECT_EQ(get_random_bits128(64), 0x0123456789abcdefULL);
    EXPECT_EQ(get_random_bits128(64), 0);

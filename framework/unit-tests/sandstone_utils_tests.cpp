...
TEST(FloatGeneration, new_random_float_prototypes) {
    ...
    // contradicting flags
    ASSERT_DEATH(new_random_bfloat8(VALUE_INF | RANDOM_GEN_FLAGS_FLOAT_FORCE_VALID), "");
    ASSERT_DEATH(new_random_bfloat8(VALUE_NAN | RANDOM_GEN_FLAGS_FLOAT_FORCE_VALID), "");
    ASSERT_DEATH(new_random_bfloat8(VALUE_SNAN | RANDOM_GEN_FLAGS_FLOAT_FORCE_VALID), "");
    ASSERT_DEATH(new_random_bfloat8(VALUE_QNAN | RANDOM_GEN_FLAGS_FLOAT_FORCE_VALID), "");
    ASSERT_DEATH(new_random_bfloat8(RANDOM_GEN_FLAGS_FLOAT_VALUE_OVERFLOW | RANDOM_GEN_FLAGS_FLOAT_FORCE_VALID), "");
    ...
    EXPECT_IN_RANGE(2, 32, BFloat8{ new_random_float(2, 32) });
    EXPECT_IN_RANGE(2, 32, HFloat8{ new_random_float(2, 32) });

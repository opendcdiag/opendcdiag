...
using RandomEngineWithMockBase = EngineWrapper<std::minstd_rand>;
struct RandomEngineWithMock : public RandomEngineWithMockBase {
    RandomEngineWithMock():
        RandomEngineWithMockBase(LCG, 0)
    {
    ...
    long int generateInt(thread_rng* rng) override {
        ...
        int val = RandomEngineWithMockBase::generateInt(rng);
        return val;
    }
    uint32_t generate32(thread_rng* rng) override {
        ...
        return RandomEngineWithMockBase::generate32(rng);
    }
    uint64_t generate64(thread_rng* rng) override {
        ...
        return RandomEngineWithMockBase::generate64(rng);
    }
    __uint128_t generate128(thread_rng* rng) override {
        ...
        return RandomEngineWithMockBase::generate128(rng);
    }
    ...
    uint32_t get_random_bits_available(thread_rng* rng) {
        return *RandomEngineWithMockBase::get_random_bits_available(rng);
    }
    RandomBitsAlgo get_random_bits_algo(thread_rng* rng) {
        return *RandomEngineWithMockBase::get_random_bits_algo(rng);
    }
};

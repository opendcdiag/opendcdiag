...
struct HFloat8
{
    ...
    constexpr inline bool is_valid() const    { return (value != HFLOAT8_INF_NAN_VALUE) && (value != HFLOAT8_SATURATED_OVERFLOW_VALUE); }
...
STATIC_INLINE bool HFloat8_is_valid(HFloat8 f)    { return (f.value != HFLOAT8_INF_NAN_VALUE) && (f.value != HFLOAT8_SATURATED_OVERFLOW_VALUE); }

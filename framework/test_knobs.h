...
#  define get_testspecific_knob_value_double(test, key, value_if_not_present) (double)(value_if_not_present)
...
double   get_testspecific_knob_value_double(const struct test *test, const char *key,
                                            double value_if_not_present);
...
static inline double  get_test_knob_value_double(const char *key, double value_if_not_present)
{ return get_testspecific_knob_value_double(NULL, key, value_if_not_present); }
